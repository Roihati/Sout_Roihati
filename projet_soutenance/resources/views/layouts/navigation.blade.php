...
<x-nav-link :href="$route" :active="$active">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('fournisseur.accueil')" :active="request()->routeIs('fournisseur.accueil')">
                {{ __('Accueil') }}
            ...
            {{--  liens admin  --}}
            @if(Auth::user()->role_id==3 || Auth::user()->role_id==2)
            <x-responsive-nav-link href="{{ route('fournisseur.product') }}" :active="request()->routeIs('fournisseur.product')">
                {{ __('Product') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link href="{{ route('fournisseur.category') }}" :active="request()->routeIs('fournisseur.category')">
                {{ __('Category') }}
            </x-responsive-nav-link>
