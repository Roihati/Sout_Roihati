...
<body class="bg-gray-100">
    <div x-data="dashboard()" class="container mx-auto px-4 py-8">
            ...
            <p>"Ensemble, cultivons la confiance et la qualité pour une chaîne d'approvisionnement performante."</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <a href="<?php echo e(route('fournisseur.product')); ?>" class="mt-4 bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded w-full">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <a href="<?php echo e(route('fournisseur.abonnement')); ?>" class="bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded block text-center">
    ...
    <?php /**PATH C:\wamp64\www\Sout_Roihati\projet_soutenance\resources\views/fournisseur/accueil.blade.php ENDPATH**/ ?>