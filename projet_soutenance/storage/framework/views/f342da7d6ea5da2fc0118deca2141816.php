        ...
        <section class="product-categories">
          ...
          <ul class="category-list">
            <li class="category-item">
              <a href="<?php echo e(route('client.products')); ?>" class="category-link">
                <i class="fas fa-shopping-bag"></i> All Products
              </a>
            </li>
            <li class="category-item">
              <a href="<?php echo e(route('client.favorite')); ?>" class="category-link">
                <i class="fas fa-fire"></i> Popular Items
              </a>
            </li>
            <li class="category-item">
              <a href="<?php echo e(route('client.order')); ?>" class="category-link">
...
<?php echo $__env->make('client.app_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Sout_Roihati\projet_soutenance\resources\views/client/Home.blade.php ENDPATH**/ ?>