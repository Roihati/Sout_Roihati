...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/app.css'); ?> <!-- Assurez-vous que Tailwind CSS est inclus -->
</head>
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="text-center">
        <h1 class="text-6xl font-bold text-gray-800">404</h1>
        <p class="text-xl text-gray-600">Oups ! La page que vous recherchez n'existe pas.</p>
        <a href="<?php echo e(url('/')); ?>" class="mt-4 inline-block bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition">Retour à l'accueil</a>
...
</html><?php /**PATH C:\wamp64\www\Sout_Roihati\projet_soutenance\resources\views/errors/404.blade.php ENDPATH**/ ?>