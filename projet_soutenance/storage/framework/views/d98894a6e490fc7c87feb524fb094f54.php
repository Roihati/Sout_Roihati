...
<html><head>
  ...
  .promo-text {
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
          ...
          <div class="mb-4">
            ...
            <select id="supplier" v-model="selectedSupplier" class="w-full p-2 border rounded">
              <option v-for="supplier in suppliers" </option>
            </select>
          </div>
          <div class="mb-4">
            ...
            <select id="product" v-model="selectedProduct" class="w-full p-2 border rounded">
              <option v-for="product in products" </option>
            </select>
          </div>
          <div class="mb-4">
    ...
    </body></html><?php /**PATH C:\wamp64\www\Sout_Roihati\projet_soutenance\resources\views/suppermarche/promotion.blade.php ENDPATH**/ ?>