	...
	<div class="<?php echo e($crud->getEditContentClass()); ?>">
		...
		<?php echo $__env->make('crud::inc.grouped_errors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		  ...
		  <?php echo method_field('PUT'); ?>
		  	...
		  	<?php echo $__env->renderWhen($crud->model->translationEnabled(), 'crud::inc.edit_translation_notice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Sout_Roihati\projet_soutenance\vendor\backpack\crud\src\resources\views\crud/edit.blade.php ENDPATH**/ ?>